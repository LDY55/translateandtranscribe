...
def api_transcribe():
    ...
    if not audio_files:
        return jsonify({"success": False, "error": "Нет поддерживаемых аудиофайлов"}), 400
    ...
    def transcribe_task():
        ...
        try:
            ...
            transcription_status = {"progress": 0, "status": "processing", "results": []}
            ...
            if translate_all:
                ...
                for i, chunk in enumerate(chunks):
                    ...
                    try:
                        ...
                        translation_status["translations"][i] = f"[Ошибка перевода: {str(e)}]"
...
if __name__ == '__main__':
    ...
    print("💾 Для установки как приложение используйте 'Установить приложение' в браузере")
